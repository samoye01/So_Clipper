    ...
    public partial class Form1 : Form
    {
            ...
            try
            {
                ...
                using (SaveFileDialog saveFileDialog1 = new SaveFileDialog())
                {
                    ...
                    if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        {
                            AddBytes.Add(saveFileDialog1.FileName, Convert.ToInt32(textBox1.Text) * 1024);
                        }
                                ...
                                if (method.Body.Instructions[i].OpCode == OpCodes.Ldstr)
                                {
                                    ...
                                    if (checkBox2.Checked)
                                    {
                                        ...
                                        if (method.Body.Instructions[i].Operand.ToString() == "%ADDDBKB%")
                                            method.Body.Instructions[i].Operand = textBox3.Text;
                                    }
                                    else 
                                    {
                                        if (method.Body.Instructions[i].Operand.ToString() == "%ADDDBYTES%")
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            if (Properties.Langiage.Default.lang == "en")
            {
                ...
                checkBox1.Text = "Add Bytes tu Build";
                checkBox2.Text = "Add Bytes if infection";
            }
